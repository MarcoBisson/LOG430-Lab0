...
export interface IProductRepository {
    ...
    */
    ...
    /**
     * Recherche des produits par terme de recherche (nom ou description).
     * @param searchTerm - Le terme de recherche.
     * @param page - Numéro de page pour la pagination.
     * @param limit - Nombre d'éléments par page.
     * @returns La liste des produits correspondants avec pagination.
     */
    searchProducts(searchTerm: string, page?: number, limit?: number): Promise<{ products: Product[]; total: number }>;
}
